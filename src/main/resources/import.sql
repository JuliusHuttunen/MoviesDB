...
insert into movie values(3, 'Chris Columbus', 'Fantasy', 'https://www.youtube.com/watch?v=1bq0qff4iF8', 'https://m.media-amazon.com/images/I/5129aHuP9UL._AC_.jpg', 2002, 'Harry Potter and the Chamber of Secrets', 2);
insert into movie values(4, 'Chris Columbus', 'Fantasy', 'https://www.youtube.com/watch?v=VyHV0BRtdxo', 'https://m.media-amazon.com/images/I/713KEd-8jyL._AC_SL1500_.jpg', 1999, 'Harry Potter and the Philosophers Stone', 2);

insert into character_movie values(2, 2);
insert into character_movie values(1, 2);
insert into character_movie values(4, 1);
insert into character_movie values(3, 3);
insert into character_movie values(5, 3);
insert into character_movie values(3, 4);
insert into character_movie values(5, 4);
